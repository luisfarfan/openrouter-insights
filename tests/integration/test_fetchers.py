...
async def test_openrouter_fetcher_success():
    ...
    with patch("ai_provider_tracker.adapters.gateways.http_fetcher.BaseHTTPFetcher.get", new_callable=AsyncMock) as mocked_get:
...
async def test_artificial_analysis_fetcher_success():
    ...
    with patch("ai_provider_tracker.adapters.gateways.artificial_analysis_fetcher.get_settings") as mocked_settings:
